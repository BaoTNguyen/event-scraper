...
pos_neg_sent <- tidytext::sentiments

networking_words <- c("network", "meet", "job", "work",
                      "friend", "relationship", "mixer", "peer",
                      "engage", "exchange", "open networking",
                      "social", "mingle", "introduction", "collaborate",
                      "partnership", "discuss", "roundtable")


seminar_words <- c("listen", "watch", "expert", "seminar", "lecture", "advice",
                   "workshop", "masterclass", "learning", "walkthrough",
                   "module", "demonstration", "training", "presentation",
                   "speaker", "Q&A", "development")
...
fin_person <- c(
    ...
    "banking", "capital", "wealth", "equity", "fund", "money", "business",
    "businesses"
  )


topic <- fin_person # choose your topic of interest here
...
nlp_type$Seminar[i] <- grepl(nlp_type[i,2], paste(seminar_words, collapse = ""))
...
-   Print in console top 3 events and why they match the persona.
